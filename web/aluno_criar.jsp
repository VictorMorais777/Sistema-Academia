    ...
    <div class="card">
        ...
        <form action="AcademiaServlet" method="post">
            ...
            <div class="form-grid">
                ...
                <div class="form-group"><label>Peso (kg) *</label><input type="number" step="0.1" name="peso" required></div>
                <div class="form-group"><label>Altura (m) *</label><input type="number" step="0.01" name="altura" required></div>
                ...
                <div class="form-group"><label>ID Plano *</label><input type="number" name="idPlano" required></div>
                <div class="form-group"><label>ID Instrutor *</label><input type="number" name="idInstrutor" required></div>
                <div class="form-group"><label>ID Treino *</label><input type="number" name="idTreino" required></div>
            </div>
